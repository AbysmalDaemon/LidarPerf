"""Produce the first real, self-verifying LidarPerf result bundle."""
...
from lidarperf.runner import run_evalio_benchmark
...
def _write_integration_protocol(root: Path, destination: Path) -> None:
    ...
    data["protocol"] = {
        "id": "lidarperf/lo-se3-hilti-step9",
        "version": 1,
    }
...
def main() -> None:
    ...
    protocol_path = args.workspace / "step9-protocol.yaml"
